...
* In Admin panel added notes about more and less
...
= 3.3.9.3 =
* Added possibility active accordion header change background color
* Added possibility active accordion header change color
...
= 3.3.9 =
* Added read more toggle sound

= 3.3.8.5 =
* Added accordion toggle click sound possibility
...
= 3.3.8.3 =
* Added Link button	URL as a required field
* Added Link URL as a required field

= 3.3.8.2 =
* Read more list fix

= 3.3.8.1 =
* Read more loading fixes
